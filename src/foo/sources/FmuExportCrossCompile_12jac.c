...
int FmuExportCrossCompile_initialAnalyticJacobianD(void* inData, threadData_t *threadData)
{
  TRACE_PUSH
  TRACE_POP
  return 1;
}
int FmuExportCrossCompile_initialAnalyticJacobianC(void* inData, threadData_t *threadData)
{
  TRACE_PUSH
  TRACE_POP
  return 1;
}
int FmuExportCrossCompile_initialAnalyticJacobianB(void* inData, threadData_t *threadData)
{
  TRACE_PUSH
  TRACE_POP
  return 1;
...
int FmuExportCrossCompile_initialAnalyticJacobianA(void* inData, threadData_t *threadData)
{
  TRACE_PUSH
  DATA* data = ((DATA*)inData);
  int index = FmuExportCrossCompile_INDEX_JAC_A;
...
int FmuExportCrossCompile_functionJacA_column(void* inData, threadData_t *threadData)
{
  TRACE_PUSH
